...
// 임시 사용자 타입 (실제로는 Context나 API에서 가져옴)
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-400 mt-1">내 활동 현황을 확인하세요</p>
        </div>
      ...
      <DarkCard variant="gold">
        ...
        <p className="text-sm text-zinc-400">
          프로필을 완성하면 더 많은 캐스팅 기회를 얻을 수 있습니다
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <DarkCard>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-zinc-400">프로필 조회</p>
        ...
        <DarkCard>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-zinc-400">찜</p>
        ...
        <DarkCard>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-zinc-400">섭외 요청</p>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4 text-sm">
            ...
            <div className="flex-1">
              <p className="text-zinc-300">스튜디오 드래곤에서 프로필을 조회했습니다</p>
              <p className="text-zinc-500">2시간 전</p>
            </div>
          </div>
          <div className="flex items-center gap-4 text-sm">
            ...
            <div className="flex-1">
              <p className="text-zinc-300">CJ ENM에서 찜 목록에 추가했습니다</p>
              <p className="text-zinc-500">어제</p>
            </div>
          </div>
          <div className="flex items-center gap-4 text-sm">
            ...
            <div className="flex-1">
              <p className="text-zinc-300">NEW에서 섭외 요청을 보냈습니다</p>
              <p className="text-zinc-500">3일 전</p>
            </div>
          </div>
        </div>
      </DarkCard>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-ivory">대시보드</h1>
          <p className="text-zinc-400 mt-1">프로젝트와 캐스팅 현황을 확인하세요</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <DarkCard>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-zinc-400">진행중 프로젝트</p>
        ...
        <DarkCard>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-zinc-400">찜한 배우</p>
        ...
        <DarkCard>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-zinc-400">보낸 섭외</p>
              <p className="text-2xl font-bold text-ivory">{stats.contacts}</p>
            </div>
          </div>
        </DarkCard>
          ...
          {[
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm text-zinc-500">{project.roles}개 배역</p>
              </div>
              <div className="w-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link href="/actor-search">
          <DarkCard variant="hover" className="group">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-zinc-700 group-hover:bg-gold/10 transition-colors flex items-center justify-center">
                <UserIcon className="w-6 h-6 text-zinc-400 group-hover:text-gold transition-colors" />
              </div>
              <div>
                <p className="text-ivory font-medium">배우 검색</p>
                <p className="text-sm text-zinc-500">조건에 맞는 배우를 찾아보세요</p>
              </div>
            </div>
          </DarkCard>
        </Link>
        ...
        <Link href="/ai-matching">
          <DarkCard variant="hover" className="group">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-zinc-700 group-hover:bg-gold/10 transition-colors flex items-center justify-center">
                <ChartBarIcon className="w-6 h-6 text-zinc-400 group-hover:text-gold transition-colors" />
              </div>
              <div>
                <p className="text-ivory font-medium">AI 매칭</p>
                <p className="text-sm text-zinc-500">시놉시스로 배우를 추천받으세요</p>
              </div>
            </div>
          </DarkCard>
        </Link>
