...
function NotificationIcon({ type }: { type: "bell" | "heart" | "megaphone" }) {
  if (type === "bell") {
    return (
      <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: "#E8F4FD" }}>
        <svg className="w-5 h-5" style={{ color: COLORS.accent.blue }} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  return (
    <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: "#F3F4F6" }}>
      <svg className="w-5 h-5" style={{ color: COLORS.text.secondary }} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    <PageLayout>
      ...
      <header className="sticky top-0 z-20 bg-white">
        ...
        <div className="px-4 pb-3">
          <div className="flex gap-2 p-1 rounded-lg border" style={{ borderColor: COLORS.border.default }}>
            {tabs.map((tab) => (
              <button
                key={tab.key}
                ...
                style={{
                  backgroundColor: activeTab === tab.key ? COLORS.accent.blue : "transparent",
