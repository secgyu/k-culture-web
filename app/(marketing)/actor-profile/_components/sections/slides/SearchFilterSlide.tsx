...
export const SearchFilterSlide = memo(function SearchFilterSlide() {
  return (
    <div className="bg-luxury-secondary border-gold/10 mx-auto max-w-5xl overflow-hidden rounded-2xl border p-6 shadow-2xl">
      <p className="text-ivory text-body-lg mb-6 text-center">오늘보다 내일이 더 빛날 배우분들을 만나보세요.</p>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4">
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-2">
              {CATEGORY_FILTER_OPTIONS.map((opt) => (
                <span key={opt} className="bg-luxury-tertiary text-ivory text-caption rounded px-3 py-1">
                  {opt}
                </span>
              ))}
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className="bg-luxury-tertiary text-ivory text-caption rounded px-3 py-1">최소</span>
              <span className="text-muted-gray">~</span>
              <span className="bg-luxury-tertiary text-ivory text-caption rounded px-3 py-1">최대</span>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="bg-luxury-tertiary text-ivory text-caption rounded px-4 py-1">100,000</span>
      ...
      <p className="text-muted-gray text-caption mb-4 text-center">필터 초기화</p>
        ...
        {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
          <div key={i} className="relative aspect-[3/4] overflow-hidden rounded-lg">
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2">
              <p className="text-caption font-medium text-white">배우{i}</p>
              <div className="mt-1 flex gap-1">
                <span className="bg-gold rounded px-1 py-0.5 text-[8px] text-white">배우</span>
              </div>
            </div>
          </div>
        ))}
