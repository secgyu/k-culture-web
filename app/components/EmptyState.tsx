  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-5">
      ...
      <p
        ...
        style={{ letterSpacing: "-0.02em", maxWidth: "280px", color: COLORS.text.secondary }}
      >
        {message.split("\n").map((line, index) => (
          <span key={index}>
            {line}
      ...
      {buttonLabel && (
        <button
          ...
          className="px-8 py-3 rounded-lg text-sm font-medium hover:border-gray-400 transition-colors"
          style={{ letterSpacing: "-0.02em", border: `1px solid ${COLORS.border.dark}`, color: COLORS.text.secondary }}
        >
          {buttonLabel}
        </button>
      )}
